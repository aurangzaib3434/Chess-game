...
Commit Title: Add base Piece class and define polymorphic structure (Zohaib Hassan)
...
Commit Title: Implement specific movement rules and path-clearing logic (Tehreem Zahra)
...
Commit Title: Initialize 2D board grid and set starting piece positions (Aurang Zaib)
